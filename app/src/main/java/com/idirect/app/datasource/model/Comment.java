...
public class Comment {
    ...
    @Expose
    private List<PreviewChildComment> previewChildComments = null;
    ...
    public List<PreviewChildComment> getPreviewChildComments() {
        return previewChildComments;
    }

    public void setPreviewChildComments(List<PreviewChildComment> previewChildComments) {
